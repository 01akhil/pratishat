  ...
  return (
    <div className='min-h-screen w-full px-4 py-8 md:px-8 lg:px-24'>
      <div className='flex flex-col md:flex-row h-full gap-4 md:gap-6'>
        {/* Left Card - Will appear first on mobile */}
        <div className="rounded-md w-full md:w-[35%] bg-white/80 p-6 md:p-8 shadow-lg transition-shadow hover:shadow-xl">
          <div className="mb-6 flex items-center gap-3">
            <div className="rounded-xl bg-blue-500 p-2">
              <Users className="h-6 w-6 text-white" />
            </div>
          ...
          <button className="mt-6 rounded-sm bg-purple-500 px-6 py-2 md:px-8 md:py-3 font-medium text-white transition-all hover:bg-purple-600 cursor-pointer w-full">
            Share your views
          </button>
        </div>

        {/* Right Cards - Will appear second on mobile */}
        <div className='flex flex-col gap-4 md:gap-6 w-full md:w-[65%]'>
          {/* Top Right Card */}
          <div className="rounded-lg bg-white/80 p-6 md:p-8 shadow-lg transition-shadow hover:shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="rounded-xl bg-blue-500 p-2">
          ...
          <div className='flex flex-col md:flex-row gap-4 md:gap-6'>
            {[
              ...
              <div
                key={index}
                className='rounded-lg bg-white/80 p-6 md:p-8 shadow-lg transition-shadow hover:shadow-xl flex-1 min-w-0'
              >
                <div className="mb-6 flex items-center gap-3">
                  <div className="rounded-xl bg-blue-500 p-2">
                    <Users className="h-6 w-6 text-white" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="mt-4 flex justify-end">
                    <button className="group relative rounded-sm text-purple-500 px-4 py-2 font-medium cursor-pointer">
                      {card.action}
                      <span className="absolute left-0 bottom-0 h-[2px] w-0 bg-purple-500 transition-all duration-300 group-hover:w-full"></span>
                    </button>
                  </div>
