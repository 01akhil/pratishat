...
const Proposal = () => {
  ...
  return (
    <div className="flex h-screen bg-white">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white z-10 border-b border-gray-200 p-4 flex justify-between items-center">
      ...
      {/* Left Sidebar */}
      <div className={`${showLeftSidebar ? 'block' : 'hidden'} lg:block fixed lg:relative z-20 lg:z-auto w-64 h-full bg-white border-r border-gray-200 flex flex-col`}>
        <div className="p-4 border-b border-gray-200 flex items-center">
          <div className="w-8 h-4 bg-gray-200 flex items-center justify-center rounded">
            <svg className="w-5 h-5 text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="3" width="7" height="7" rx="1" stroke="currentColor" strokeWidth="2" />
      ...
      <div className="flex-1 flex overflow-y-auto mt-16 lg:mt-0">
        ...
        {/* Right Sidebar */}
        <div className={`${showRightSidebar ? 'block' : 'hidden'} lg:block fixed lg:relative right-0 z-20 lg:z-auto w-64 h-full bg-white border-l border-gray-200 p-4 overflow-y-auto`}>
          <div className="flex items-center mb-6">
            <button className="text-xs border border-gray-300 rounded-lg px-4 py-1 text-gray-700 mr-2">
              Draft
            </button>
            ...
            <button 
              className="ml-10 text-gray-400 lg:hidden"
