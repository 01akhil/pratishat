...
//               <Link href='/proposal' className='cusor:pointer'>
...
const Survey = () => {
  ...
  return (
    <div className="flex h-screen bg-white">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white z-20 border-b border-gray-200 p-4 flex justify-between items-center">
      ...
      {/* Left Sidebar */}
      <div className={`fixed lg:relative z-10 lg:z-0 w-64 border-r border-gray-200 flex flex-col bg-white h-full transition-transform duration-300 ease-in-out 
      ...
      {/* Main Content */}
      <div className="flex-1 flex overflow-y-auto mt-16 lg:mt-0">
        <div className="flex-1 overflow-auto p-4 lg:p-6">
          <div className="border-b border-gray-200 pb-6">
            <div className="flex items-center justify-between">
              <div className="relative w-full mt-4 lg:mt-7">
                <input 
                  type="text" 
                  className="w-full text-xs border border-gray-300 rounded-lg py-3 px-4 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Survey Name"
            ...
            <div className="mt-8 flex justify-center">
              <button className="bg-emerald-400 text-white rounded-lg px-8 lg:px-16 py-3 font-medium">
                Create Questionnaire
              </button>
            </div>
          </div>
        ...
        {/* Right Sidebar */}
        <div className={`fixed lg:relative z-10 lg:z-0 w-64 border-l border-gray-200 p-4 bg-white h-full right-0 transition-transform duration-300 ease-in-out 
          ...
          <div className="flex items-center mb-6">
            ...
            <button className="ml-10 text-gray-400 lg:hidden" onClick={() => setShowRightSidebar(false)}>
              <XMarkIcon className="w-6 h-6" />
            </button>
          </div>
