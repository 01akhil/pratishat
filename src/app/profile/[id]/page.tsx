...
//   <span className="hidden md:inline">Prati</span>
//   <span className="hidden md:inline text-[#a3d9c9]">Shat</span>
// </h1>
...
export default async function UserProfilePage({ params }: Props) {
  ...
  return (
    <div className="font-sans max-w-screen-xl mx-auto">
      {/* Header */}
      <header className="h-16 border-b border-gray-100 flex items-center justify-between px-4 md:px-6">
        <h1 className="hidden md:block text-xl md:text-2xl font-bold text-[#2d4b6d]">
